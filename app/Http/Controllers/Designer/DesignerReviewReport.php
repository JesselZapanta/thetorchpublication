...
class DesignerReviewReport extends Controller
{
    ...
    {   
        ...
        return inertia('Designer/Review/Publication/Index', [
    ...
    public function hidePublication($id)
    {
        ...
        return to_route('designer-review-report-publication.index')->with(['success' => 'Archive successfully..']);
    }
    public function restorePublication($id)
    {
        ...
        if($publication->archive_by != Auth::user()->id){
            return to_route('designer-review-report-publication.index')->with(key: ['error' => 'Unable to restore the content. This content was archived by an administrator.']);
        }

        $publication->update(['archive_by' => null ]);
        $publication->update(['visibility' => 'visible']);

        return to_route('designer-review-report-publication.index')->with(['success' => 'Restore successfully..']);
    }
    ...
    public function rejectPublicationReport($id)
    {
        ...
        return to_route('designer-review-report-publication.index')->with(['success' => 'Reject successfully..']);
    }
    ...
    public function destroyPublication($id)
    {
        ...
        return to_route('designer-review-report-publication.index')->with(['success' => 'Delete successfully..']);
    }
