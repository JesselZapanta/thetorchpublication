...
export default function FreedomWallEntries({
    ...
    const handleSpeak = (entry) => {
        ...
        if (isSpeaking === entry.id) {
            ...
            // Normalize the entry body and strip HTML tags
            const cleanEntryBody = normalizeText(stripHtml(entry.body)); // Normalize body content

            // Create a SpeechSynthesisUtterance with the normalized body
            const textToRead = `${cleanEntryBody}`;
