...
export default function Index({ auth, reportedComments, queryParams, flash, DesignerBadgeCount }) {
    ...
    const searchFieldChanged = (name, value) => {
        if (value === "") {
            ...
            router.get(
                route("designer-review-report-comment.index"),
                queryParams,
                {
                    preserveState: true,
                }
        ...
        if (confirmAction.comment) {
            switch (confirmAction.type) {
                case "hide":
                    router.post(
                        route(
                            "designer-review-report-comment.hide",
                ...
                case "restore":
                    router.post(
                        route(
                            "designer-review-report-comment.restore",
                            confirmAction.comment.id
                        ),
                        {
                            preserveScroll: true,
                ...
                case "reject":
                    router.post(
                        route(
                            "designer-review-report-comment.reject",
                            confirmAction.comment.id
                        ),
                        {
                            preserveScroll: true,
                ...
                case "delete":
                    router.delete(
                        route(
                            "designer-review-report-comment.destroy",
                            confirmAction.comment.id
                        ),
                        {
                            preserveScroll: true,
                                                    ...
                                                    >
                                                        ...
                                                        <th className="px-3 py-2 text-gray-100 text-nowrap hover:underline">
                                                            <Link
                                                                ...
                                                                href={route(
                                                                    "designer-review-report-comment.show",
                                                                    {
                                                                        comment_id:
                                                                            comment.id,
                                                                    }
