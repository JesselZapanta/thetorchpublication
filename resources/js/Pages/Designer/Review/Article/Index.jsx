...
export default function Index({
    ...
    const searchFieldChanged = (name, value) => {
        if (value === "") {
            ...
            router.get(
                route("designer-review-report-article.index"),
                queryParams,
                {
                    preserveState: true,
                }
        ...
        if (confirmAction.article) {
            switch (confirmAction.type) {
                case "hide":
                    router.post(
                        route(
                            "designer-review-report-article.hide",
                ...
                case "restore":
                    router.post(
                        route(
                            "designer-review-report-article.restore",
                            confirmAction.article.id
                        ),
                        {
                            preserveScroll: true,
                ...
                case "reject":
                    router.post(
                        route(
                            "designer-review-report-article.reject",
                            confirmAction.article.id
                        ),
                        {
                            preserveScroll: true,
                ...
                case "delete":
                    router.delete(
                        route(
                            "designer-review-report-article.destroy",
                            confirmAction.article.id
                        ),
                        {
                            preserveScroll: true,
                                                    ...
                                                    >
                                                        ...
                                                        <th className="px-3 py-2 text-gray-100 text-nowrap hover:underline">
                                                            <Link
                                                                ...
                                                                href={route(
                                                                    "designer-review-report-article.show",
                                                                    article.slug
                                                                )}
                                                            >
                                                                {truncate(
