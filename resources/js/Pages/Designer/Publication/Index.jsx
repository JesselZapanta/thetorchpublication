...
export default function Index({
    ...
    const searchFieldChanged = (name, value) => {
        if (value === "") {
            ...
            router.get(route("designer-publication.index"), queryParams, {
                preserveState: true,
    ...
    const onKeyPressed = (name, e) => {
        ...
        if (e.key === "Enter") {
            ...
            if (value.trim() === "") {
                ...
                router.get(
                    route("designer-publication.index"),
                    {},
                    {
                        preserveState: true,
                    }
    ...
    const handleDelete = () => {
        if (publication) {
            router.delete(
                route("designer-publication.destroy", publication.id)
            );
        }
