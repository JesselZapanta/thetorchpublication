...
import NewsletterBarChart from "@/Components/Chart/NewsletterBarChart";
    ...
    return (
        ...
        >
            ...
            {/* <pre className="text-gray-900">
                {JSON.stringify(categoriesWithArticleCount, null, 2)}
            </pre> */}
                                ...
                                <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                                    <div className="p-6 text-gray-900 dark:text-gray-100">
                                        ...
                                        <p className="text-md mt-4">
                                            <span className="mr-2">
                                                {
                                                    reportData.distributedNewsletter
                                                }
                                            </span>
                                        </p>
                                    </div>
                                ...
                                <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                                    <div className="p-6 text-gray-900 dark:text-gray-100">
                                        ...
                                        <p className="text-md mt-4">
                                            <span className="mr-2">
                                                {
                                                    reportData.undistributedNewsletter
                                                }
                                            </span>
                                        </p>
                                    </div>
