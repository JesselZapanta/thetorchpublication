...
export default function Index({
    ...
    const searchFieldChanged = (name, value) => {
        if (value === "") {
            ...
            router.get(
                route("writer-review-report-article.index"),
                queryParams,
                {
                    preserveState: true,
                }
    ...
    const handleSelectChange = (name, value) => {
        ...
        router.get(route("writer-review-report-article.index"), queryParams, {
            preserveState: true,
        });
    };
        ...
        if (confirmAction.article) {
            switch (confirmAction.type) {
                case "hide":
                    router.post(
                        route(
                            "writer-review-report-article.hide",
                ...
                case "restore":
                    router.post(
                        route(
                            "writer-review-report-article.restore",
                            confirmAction.article.id
                        ),
                        {
                            preserveScroll: true,
                ...
                case "reject":
                    router.post(
                        route(
                            "writer-review-report-article.reject",
                            confirmAction.article.id
                        ),
                        {
                            preserveScroll: true,
                ...
                case "delete":
                    router.delete(
                        route(
                            "writer-review-report-article.destroy",
                            confirmAction.article.id
                        ),
                        {
                            preserveScroll: true,
