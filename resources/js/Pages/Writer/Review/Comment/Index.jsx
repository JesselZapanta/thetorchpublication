...
export default function Index({ auth, reportedComments, queryParams, flash, WriterBadgeCount }) {
    ...
    const searchFieldChanged = (name, value) => {
        if (value === "") {
            ...
            router.get(
                route("writer-review-report-comment.index"),
                queryParams,
                {
                    preserveState: true,
                }
    ...
    const handleSelectChange = (name, value) => {
        ...
        router.get(route("writer-review-report-comment.index"), queryParams, {
            preserveState: true,
        });
    };
        ...
        if (confirmAction.comment) {
            switch (confirmAction.type) {
                case "hide":
                    router.post(
                        route(
                            "writer-review-report-comment.hide",
                ...
                case "restore":
                    router.post(
                        route(
                            "writer-review-report-comment.restore",
                            confirmAction.comment.id
                        ),
                        {
                            preserveScroll: true,
                ...
                case "reject":
                    router.post(
                        route(
                            "writer-review-report-comment.reject",
                            confirmAction.comment.id
                        ),
                        {
                            preserveScroll: true,
                ...
                case "delete":
                    router.delete(
                        route(
                            "writer-review-report-comment.destroy",
                            confirmAction.comment.id
                        ),
                        {
                            preserveScroll: true,
