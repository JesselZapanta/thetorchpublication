...
export default function Index({
    ...
    const searchFieldChanged = (name, value) => {
        if (value === "") {
            ...
            router.get(
                route("admin-review-report-publication.index"),
                queryParams,
                {
                    preserveState: true,
                }
    ...
    const handleSelectChange = (name, value) => {
        ...
        router.get(route("admin-review-report-publication.index"), queryParams, {
            preserveState: true,
        });
    };
    ...
    //         router.get(route("admin-review-report-publication.index"));
        ...
        if (confirmAction.publication) {
            switch (confirmAction.type) {
                case "hide":
                    router.post(
                        route(
                            "admin-review-report-publication.hide",
                ...
                case "restore":
                    router.post(
                        route(
                            "admin-review-report-publication.restore",
                            confirmAction.publication.id
                        ),
                        {
                            preserveScroll: true,
                ...
                case "reject":
                    router.post(
                        route(
                            "admin-review-report-publication.reject",
                            confirmAction.publication.id
                        ),
                        {
                            preserveScroll: true,
                ...
                case "delete":
                    router.delete(
                        route(
                            "admin-review-report-publication.destroy",
                            confirmAction.publication.id
                        ),
                        {
                            preserveScroll: true,
