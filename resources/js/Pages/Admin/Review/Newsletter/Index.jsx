...
export default function Index({
    ...
    const searchFieldChanged = (name, value) => {
        if (value === "") {
            ...
            router.get(
                route("admin-review-report-newsletter.index"),
                queryParams,
                {
                    preserveState: true,
                }
    ...
    const handleSelectChange = (name, value) => {
        ...
        router.get(route("admin-review-report-newsletter.index"), queryParams, {
            preserveState: true,
        });
    };
    ...
    //     if (value === "newsletter") {
    //         router.get(route("admin-review-report-newsletter.index"));
        ...
        if (confirmAction.newsletter) {
            switch (confirmAction.type) {
                case "hide":
                    router.post(
                        route(
                            "admin-review-report-newsletter.hide",
                ...
                case "restore":
                    router.post(
                        route(
                            "admin-review-report-newsletter.restore",
                            confirmAction.newsletter.id
                        ),
                        {
                            preserveScroll: true,
                ...
                case "reject":
                    router.post(
                        route(
                            "admin-review-report-newsletter.reject",
                            confirmAction.newsletter.id
                        ),
                        {
                            preserveScroll: true,
                ...
                case "delete":
                    router.delete(
                        route(
                            "admin-review-report-newsletter.destroy",
                            confirmAction.newsletter.id
                        ),
                        {
                            preserveScroll: true,
