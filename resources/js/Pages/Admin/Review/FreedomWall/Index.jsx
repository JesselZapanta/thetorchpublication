...
export default function Index({
    ...
    const searchFieldChanged = (name, value) => {
        if (value === "") {
            ...
            router.get(
                route("admin-review-report-freedom-wall.index"),
                queryParams,
                {
                    preserveState: true,
                }
        ...
        if (confirmAction.entry) {
            switch (confirmAction.type) {
                case "hide":
                    router.post(
                        route(
                            "admin-review-report-freedom-wall.hide",
                ...
                case "restore":
                    router.post(
                        route(
                            "admin-review-report-freedom-wall.restore",
                            confirmAction.entry.id
                        ),
                        {
                            preserveScroll: true,
                ...
                case "reject":
                    router.post(
                        route(
                            "admin-review-report-freedom-wall.reject",
                            confirmAction.entry.id
                        ),
                        {
                            preserveScroll: true,
                ...
                case "delete":
                    router.delete(
                        route(
                            "admin-review-report-freedom-wall.destroy",
                            confirmAction.entry.id
                        ),
                        {
                            preserveScroll: true,
                                                    ...
                                                    >
                                                        ...
                                                        <th className="px-3 py-2 text-gray-100 text-nowrap hover:underline">
                                                            <Link
                                                                ...
                                                                href={route(
                                                                    "admin-review-report-freedom-wall.show",
                                                                    entry.id
                                                                )}
                                                            >
                                                                {truncate(
