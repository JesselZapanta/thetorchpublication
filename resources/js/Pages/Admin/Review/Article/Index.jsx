...
export default function Index({ auth, reportedArticle, queryParams = null, flash }) {
    ...
    const searchFieldChanged = (name, value) => {
        if (value === "") {
            ...
            router.get(
                route("admin-review-report-article.index"),
                queryParams,
                {
                    preserveState: true,
                }
        ...
        if (confirmAction.article) {
            switch (confirmAction.type) {
                case "hide":
                    router.post(
                        route(
                            "admin-review-report-article.hide",
                ...
                case "restore":
                    router.post(
                        route(
                            "admin-review-report-article.restore",
                            confirmAction.article.id
                        ),
                        {
                            preserveScroll: true,
