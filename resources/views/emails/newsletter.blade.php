...
<head>
    <title>The-Torch-Publication</title>
                            ...
                            <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation">
                                <tr>
                                    <td class="content-cell">
                                        <h1 style="color: #3d4852; font-size: 18px; font-weight: bold; margin-top: 0; text-align: justify;">
                                            {{ $newsletter->description }}
                                        </h1>
                                        <p style="font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: justify;">
                                            {{ $messages }}
                                        </p>
                                ...
                                <tr>
                                    <td class="content-cell" align="center">
                                        <p style="line-height: 1.5em; margin-top: 0; color: #b0adc5; font-size: 12px; text-align: center;">
                                            ©The-Torch-Publication. All rights reserved.
                                        </p>
                                    </td>
                                </tr>
                            </table>
